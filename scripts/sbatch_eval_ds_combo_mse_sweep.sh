#!/usr/bin/env bash
#SBATCH --job-name=ds_combo_mse_eval
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --time=08:00:00
#SBATCH --output=logs/slurm/ds_combo_mse_eval_%j.out

# Post-training eval + analysis for all 15 MSE ds_combo models.
...
RUNS="$ROOT/ae_results/contrastive_run/ds_combo_enlcrop_sc2_lc010_bal_mse"
