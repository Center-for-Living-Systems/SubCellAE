#!/usr/bin/env python3
"""
setup_le_b12_ds1_lat12p8.py

Generate YAML configs for DS1 B12 label-efficiency benchmark with:
  - lat=12, proj=8
  - No n_labeled_per_class (bug-fixed version of le_b12_supcon DS1)

Reuses annotation CSVs from le_b12_supcon (same folds, same budget subsets).
DS1 only (vinc ctrl+ycomp).
Budgets: 10,20,25,50,75,100,150,200,300,400,500,750 + all
Jobs: 5 folds × (12 budgets × 5 repeats + 1 all) = 305

Usage:
  python scripts/setup_le_b12_ds1_lat12p8.py [--dry-run]
"""
...
RUN_TAG     = "le_b12_ds1_lat12p8"
SRC_ANN_TAG = "le_b12_supcon"
DS          = "ds1"
N_FOLDS     = 5
N_REPEATS   = 5
BUDGETS     = [10, 20, 25, 50, 75, 100, 150, 200, 300, 400, 500, 750]
