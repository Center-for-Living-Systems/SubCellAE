#!/usr/bin/env bash
#SBATCH --job-name=combo_clip01_train
...
#SBATCH --array=0-14
#SBATCH --output=logs/slurm/ds_combo_clip01_l1_train_%A_%a.out

# Training sweep — clip [0,1] / no sc2 / L1 — 15 dataset combinations.
...
CFG="config/contrastive_config/ds_combo_v3/ae_conae_enlcrop_clip01_l1_lc010_bal_${COMBO}.yaml"
