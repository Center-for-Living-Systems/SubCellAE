#!/usr/bin/env bash
#SBATCH --job-name=combo_prt_eval
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --time=08:00:00
#SBATCH --output=logs/slurm/ds_combo_prt_l1_eval_%j.out

# Post-training eval + analysis for all 15 prt ds_combo models.
# (cio_mode_prt, no clip, no sigmoid, L1 loss)
...
RUNS="$ROOT/ae_results/contrastive_run/ds_combo_enlcrop_prt_l1"
