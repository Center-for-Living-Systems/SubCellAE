#!/usr/bin/env bash
#SBATCH --job-name=le_b12d1_hi
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=logs/slurm/le_b12_ds1_nb1000_1500_%A_%a.out
...
JOB_LIST="config/${RUN_TAG}/job_list_nb1000_1500.txt"
...
ANN_CSV="${DATA}/labelling/le_b12_supcon/le_b12_ds1_fv${FOLD}_nb${BUDGET}_r${REPEAT}.csv"
FOLD_SPLITS="${DATA}/labelling/le_b12_supcon/fold_splits_ds1.csv"
