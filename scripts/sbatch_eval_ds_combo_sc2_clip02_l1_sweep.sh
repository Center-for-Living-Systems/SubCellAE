#!/usr/bin/env bash
#SBATCH --job-name=combo_clip02_eval
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --time=08:00:00
#SBATCH --output=logs/slurm/ds_combo_sc2_clip02_l1_eval_%j.out

# Post-training eval + analysis for all 15 clip_02 ds_combo models.
# (CIO, clip [0,2] + sc2 ÷2 → [0,1], L1 loss)
...
RUNS="$ROOT/ae_results/contrastive_run/ds_combo_enlcrop_sc2_clip02_l1"
