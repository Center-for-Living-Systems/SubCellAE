#!/usr/bin/env bash
#SBATCH --job-name=le_comb_s2
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=32G
#SBATCH --time=8:00:00
#SBATCH --output=logs/slurm/le_comb_s2_%A_%a.out

# Combined efficiency s2v2 — 225 jobs: 3 series × 15 N_images × 5 npi
#   Series 0: --array=0-74
...
JOB_LIST="config/le_combined_s2v2_job_list.txt"
