#!/usr/bin/env bash
#SBATCH --job-name=le_vc_12p8
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=logs/slurm/le_vc_lat12p8_%A_%a.out
...
ANN_CSV="${DATA}/labelling/le_b2_vinc_ctrl/le_b2_vinc_ctrl_fv${FOLD}_nb${BUDGET}_r${REPEAT}.csv"
