#!/usr/bin/env bash
#SBATCH --job-name=ds_combo_l1_train
...
#SBATCH --array=0-14
#SBATCH --output=logs/slurm/ds_combo_l1_train_%A_%a.out

# Training sweep — L1 loss — 15 dataset combinations, enlcrop/sc2/lc010/balanced.
...
CFG="config/contrastive_config/ds_combo_v2/ae_conae_enlcrop_sc2_l1_lc010_bal_${COMBO}.yaml"
