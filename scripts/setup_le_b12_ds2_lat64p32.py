#!/usr/bin/env python3
"""
setup_le_b12_ds2_lat64p32.py

Generate YAML configs for DS2 B12 label-efficiency benchmark with:
  - lat=64, proj=32
  - No n_labeled_per_class

Reuses annotation CSVs from le_b12_supcon. DS2 only (pfak ctrl+ycomp).
Budgets: 10, 20, 25, 50, 75, 100, 150, all — 180 jobs total.

Usage:
  python scripts/setup_le_b12_ds2_lat64p32.py [--dry-run]
"""
