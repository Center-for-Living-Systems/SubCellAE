#!/usr/bin/env bash
#SBATCH --job-name=le_b2d1_np
#SBATCH --partition=general
#SBATCH --gres=gpu:a40:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=logs/slurm/le_b2_ds1_nplc_%A_%a.out
...
ANN_CSV="${DATA}/labelling/le_b2_supcon/le_b2_ds1_fv${FOLD}_nb${BUDGET}_r${REPEAT}.csv"
