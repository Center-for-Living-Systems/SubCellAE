#!/usr/bin/env bash
# submit_multichannel_cio_jobs.sh
# Train 4 multi-channel ConAE models on vinc (ds1) with CIO normalization.
#   4ch (vinc+pax+zyx+act): lat18proj12, lat24proj16
#   3ch (pax+zyx+act):      lat18proj12, lat24proj16
# Eval chain per model: run_contrastive_eval + run_cluster_panels + run_cross_dataset_eval
...
RUNNER=$REPO/scripts/run_ae_from_config.py
...
echo "=== Submitting 4ch vinc CIO (vinc+pax+zyx+act) jobs ==="
submit_chain \
    "ae_contrastive_cio_vinc_lat18proj12_enlcrop_sc2_nl1_4ch_vinc" \
    "contrastive_cio_vinc_lat18proj12_enlcrop_sc2_nl1_4ch_vinc"

submit_chain \
    "ae_contrastive_cio_vinc_lat24proj16_enlcrop_sc2_nl1_4ch_vinc" \
    "contrastive_cio_vinc_lat24proj16_enlcrop_sc2_nl1_4ch_vinc"

echo "=== Submitting 3ch pza CIO (pax+zyx+act) jobs ==="
submit_chain \
    "ae_contrastive_cio_vinc_lat18proj12_enlcrop_sc2_nl1_3ch_pza" \
    "contrastive_cio_vinc_lat18proj12_enlcrop_sc2_nl1_3ch_pza"

submit_chain \
    "ae_contrastive_cio_vinc_lat24proj16_enlcrop_sc2_nl1_3ch_pza" \
    "contrastive_cio_vinc_lat24proj16_enlcrop_sc2_nl1_3ch_pza"

echo "All jobs submitted. 4 train + 12 eval/panels/xeval = 16 total jobs."
