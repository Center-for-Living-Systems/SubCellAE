#!/usr/bin/env bash
#SBATCH --job-name=ds_combo_train
...
#SBATCH --array=0-14
#SBATCH --output=logs/slurm/ds_combo_train_%A_%a.out

# Training sweep — 15 dataset combinations, enlcrop/sc2/nL1/lc025.
# Each array task trains one combo.  Combo list is generated by
#   python scripts/generate_ds_combo_configs.py
# and stored in config/contrastive_config/ds_combo/combo_list.txt
...
CFG="config/contrastive_config/ds_combo/ae_conae_enlcrop_sc2_nl1_lc025_${COMBO}.yaml"
